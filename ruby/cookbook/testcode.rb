...
hotcakes = Recipe.new("Hotcakes", ["flour", "milk", "eggs"], ["mix ingredients", "pour hotcakes on hot skillet", "flip when bubbles are on the edge"])
mex_cuisine.add_recipe(hotcakes)
